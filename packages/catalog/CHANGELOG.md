...
- feat(catalog): add DeepSeek V4.1 Flash (`deepseek-flash`), retire `deepseek-v4-flash-vision-exp`, default DeepSeek provider to `deepseek-flash` ([#11508](https://github.com/can1357/oh-my-pi/issues/11508)).
